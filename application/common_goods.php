...
{
    return str_replace(array('offline', 'online', 'alipay', 'alipay_h5', 'alipay_app', 'wxpay_native', 'wxpay_jsapi', 'wxpay_h5', 'wxpay_app', 'predeposit'), array('货到付款', '在线付款', '支付宝支付', '支付宝手机支付', '支付宝APP支付', '微信扫码支付', '微信公众号支付', '微信H5支付', '微信APP支付', '站内余额支付'), $payment_code);
}
...
{
    return str_replace(array('1', '2', '3', '4', '5','6','7'), array('', '抢购', '限时折扣', '(套餐商品)', '赠品','拼团','会员折扣'), $goods_type);
}
